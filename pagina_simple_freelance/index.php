    ...
    <header class="masthead mb-auto">
      <div class="inner">
        ...
        <nav class="nav nav-masthead justify-content-center">
          ...
          <a class="nav-link" href="formularios/registro_usuarios.php">Registro de usuarios</a>
          <a class="nav-link" href="formularios/inicio_sesion.php">Inicio de sesión</a>
          <a class="nav-link" href="formularios/contacto.php">Contacto</a>
        </nav>
      </div>
    </header>
